...
-(void)setUpBtn
{
    ...
    [_confirmBtn setBackgroundColor:XXYMainColor];
...
-(void)lastBtnCliked:(UIButton*)btn
{
    switch (btn.tag)
    {
        ...
        case 101:
        {
            [[UIApplication sharedApplication]openURL:[NSURL URLWithString:@"http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=1156758711&pageNumber=0&sortOrdering=2&type=Purple+Software&mt=8"]];
        }
            break;
        default:
            break;
