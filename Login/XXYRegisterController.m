...
-(void)setUpRegisterView
{
 ...
 [_passwordTextField addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
    ...
    _registerBtn=[[UIButton alloc]initWithFrame:CGRectMake(10, _picHeight+230, MainScreenW-20, 45)];
    _registerBtn.layer.cornerRadius=5;
    [_registerBtn setBackgroundColor:XXYMainColor];
    ...
    dispatch_source_set_event_handler(_timer, ^{
        ...
        if(timeout<=0){ //倒计时结束，关闭
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                {
                   [_getVerificationCodeBtn setBackgroundColor:XXYMainColor];
                }
                else
                {
                   [_getVerificationCodeBtn setBackgroundColor:[UIColor colorWithRed:205.0/255 green:205.0/255 blue:205.0/255 alpha:1.0]];
...
-(void)registerBtnClicked:(UIButton*)btn
{
    ...
    else
    {
        ...
        [BSHttpRequest POST:requestUrl parameters:@{@"username":_phoneTextField.text,@"password":_passwordTextField.text,@"type":@3,@"mobileNo":_phoneTextField.text,@"otp":_verificationCodeTextField.text} success:^(id responseObject){
