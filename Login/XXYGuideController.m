...
-(void)setUpGuideScrollowView
{
    ...
    _guideScrollView=[[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, MainScreenW, sHeight)];
    ...
    for(int i=0;i<3;i++)
    {
        //UIImageView*imageView=[[UIImageView alloc]initWithFrame:CGRectMake(i*MainScreenW, 0, MainScreenW, MainScreenW*22/15)];
    ...
    _pageControl.currentPageIndicatorTintColor=XXYMainColor;
...
-(void)setUpBtns
{
    ...
    _guideLoginBtn.layer.borderColor=XXYMainColor.CGColor;
    [_guideLoginBtn setBackgroundColor:[UIColor whiteColor]];
    [_guideLoginBtn setTitle:@"登录" forState:UIControlStateNormal];
    [_guideLoginBtn setTitleColor:XXYMainColor forState:UIControlStateNormal];
    ...
    _guideRegisterBtn.layer.borderColor=XXYMainColor.CGColor;
    [_guideRegisterBtn setBackgroundColor:XXYMainColor];
